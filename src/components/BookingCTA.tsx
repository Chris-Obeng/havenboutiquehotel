  ...
  return (
    ...
    >
      <div className="max-w-xl mx-auto">
        <div
          ref={lineRef}
          className="w-[40px] md:w-[52px] h-[1px] bg-[#C9A96E] mb-10 md:mb-14 mx-auto"
        />
        ...
        >
          Reach out to our team to check availability and arrange your stay at
          Haven.
        </p>
